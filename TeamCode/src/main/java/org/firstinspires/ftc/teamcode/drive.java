...
public class drive {
    ...
    public drive(HardwareMap hardwareMap) {
        ...
        frontLeft0 = hardwareMap.get(DcMotor.class, "FrontLeft");
        frontRight1 = hardwareMap.get(DcMotor.class, "FrontRight");
        backLeft2 = hardwareMap.get(DcMotor.class, "BackLeft");
        backRight3 = hardwareMap.get(DcMotor.class, "BackRight");
